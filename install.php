...
$plugin_name = 'puppet_external_nodes';

// Set a title
$window['title'] = "Puppet External Node Install";
...
//
$pmodules = array();
$pmodules['puppet_external_node']['desc'] = 'Return external node yaml for puppet';
$pmodules['puppet_node_env_set']['desc'] = 'Set puppet external node environment';
$pmodules['puppet_node_class_add']['desc'] = 'Add puppet external node class';
$pmodules['puppet_node_class_del']['desc'] = 'Delete puppet external node class';
$pmodules['puppet_node_parm_add']['desc'] = 'Add puppet external node parameter';
$pmodules['puppet_node_parm_del']['desc'] = 'Delete puppet external node parameter';
$pmodules['puppet_node_copy']['desc'] = 'Copy puppet external node data from host to host';
...
$ppermissions['puppet_ext_node_view']['desc'] = 'View puppet external node data';
...
if (!function_exists('yaml_emit')) {
    $window['html'] .= "<br><img src='{$images}/silk/error.png' border='0'><font color=\"orange\"> WARNING=> The PHP YAML parsing functions are not installed!</font><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please install the 'php-yaml' functions.<br>";
}
